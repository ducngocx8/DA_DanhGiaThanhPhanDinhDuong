...
import { MonAnAdminURL, NhomMonAnAdminURL } from "../../../../api/Admin";
import { BACKEND_HOME } from "../../../../api";
import FormConfirm from "./FormConfirm";
import FormSearchThucPhamAdd from "./FormSearchThucPhamAdd";

export default function FormAddMonAn({
  closeFormAdd,
  loadData,
  setPage,
  params,
  ...
  const addProduct = async (newProduct) => {
    const response = await axios.post(`${MonAnAdminURL}${params}`, newProduct, {
      withCredentials: true,
    });
