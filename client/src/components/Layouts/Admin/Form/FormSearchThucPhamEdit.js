...
import { ChiTietMonAdminURL } from "../../../../api/Admin";
import { useNavigate } from "react-router-dom";

export default function FormSearchThucPhamEdit({ reloadData, id_monan }) {
  ...
  const handleAdd = async () => {
    ...
    const response = await axios.post(`${ChiTietMonAdminURL}`, chi_tiet_mon, {
      withCredentials: true,
    });
        ...
        >
          ...
          >
            <div style={{ textAlign: "center", color: "#007bff" }}>
              {showFormInputQuanty.ten_thuc_pham}
            </div>
                ...
                <tr
                  ...
                  onClick={() => {
                    handleShowFormInputQuanty({
                      ...
                      ten_thuc_pham: item.TenTiengViet || item.TenTiengAnh,
                    });
                  }}
