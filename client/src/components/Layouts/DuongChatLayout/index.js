...
export default function DuongChatLayout() {
  const maxShow = 30;
    ...
    if (duongChatSelected !== "") {
      const getAllThucPhamDuongChat = async () => {
        const response = await axios.get(
          `${
            ThucPhamURL + "/tra-cuu/duong-chat?code=" + duongChatSelected
          }&sort=${sortType}`
        );
        if (response.data.status) {
            ...
            <tr className="table-white">
              ...
              <td>
                {
                  ...
                  >
                    {item.TenTiengViet || index.TenTiengAnh}
                  </Link>
                }
              </td>
              <td>
              ...
              <td>
                <Link
                  ...
                  to={"/dinh-duong/" + thucphamList[index + 1].id_thucpham}
                >
                  {thucphamList[index + 1].TenTiengViet ||
                    thucphamList[index + 1].TenTiengAnh}
                </Link>
              </td>
              <td>
        ...
        <div style={{ flex: 3 }}>
          ...
          >
            ...
            <span className="favorite_book_list_title mg-l-10">
              Danh sách thực phẩm giàu dưỡng chất
            </span>
          </div>
          <div className="favorite_book_item mg-10_0">
            ...
            >
              ...
              <div>(hàm lượng có trong 100g thực phẩm)</div>
            </p>
