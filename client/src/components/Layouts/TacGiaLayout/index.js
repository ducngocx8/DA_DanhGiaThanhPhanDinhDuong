...
export default function TacGiaLayout({ tacGiaChoose }) {
          ...
          <div>
            <div style={{ display: "flex" }}>
              ...
              >
                ...
                >
                  {"Tác giả: " + tacGiaChoose.username}
                </div>
                <div>
                  {tacGiaChoose.BaiViets.length > 0 ? (
                    <Fragment>
                      {tacGiaChoose.BaiViets.map((post, index) => {
                        if (
                          ...
                          return (
                            ...
                            >
                              ...
                              {index === tacGiaChoose.BaiViets.length - 1 ? (
                                <div
                                  style={{
                                    marginBottom: 10,
                                  }}
                      ...
                      <ReactPaginate
                        ...
                        pageCount={
                          tacGiaChoose.BaiViets.length <= maxShow
                            ? 1
                            : tacGiaChoose.BaiViets.length % maxShow === 0
                            ? Math.floor(
                                tacGiaChoose.BaiViets.length / maxShow
                              )
                            : Math.floor(
